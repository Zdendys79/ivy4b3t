...
class DashboardController extends BaseController
{
    ...
    protected function init()
    {
        ...
        // Initialize services
        $this->logger = new SystemLogger($this->db, $this->debug_mode);
        $this->statusService = new SystemStatusService($this->db, $this->logger);
        $this->commandService = new SystemCommandService($this->db, $this->logger);
        $this->userService = new UserManagementService($this->db, $this->logger);
