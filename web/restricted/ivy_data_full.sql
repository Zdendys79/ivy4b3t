...
('500000', 'ivy4b3t', 'složka', 'Root složka celého projektu', 'done', 1, NULL, NULL),
  ('510000', 'ivy', 'složka', 'Klientská část a logika robotů', 'done', 1, NULL, NULL),
    ...
    ('513000', 'iv_fb.js', 'soubor', 'Modul pro interakci s Facebookem', 'done', 1, NULL, NULL),
    ...
    ('518000', 'start.sh', 'soubor', 'Bash skript pro opakované spouštění pupp.js', 'done', 1, NULL, NULL),
    ('519000', 'loginuser.js', 'soubor', 'Skript pro správu FB uživatele na webu', 'done', 1, NULL, NULL),
    ('51A000', 'cycleusers.js', 'soubor', 'Cyklické přepínání uživatelů na virtuálu pro vytvoření profilů browseru a přihlášení na Facebook', 'done', 1, NULL, NULL),
...
('600000', 'Databáze ivy', 'database', 'MariaDB databáze projektu běžící na VPS00', 'done', 1, NULL, NULL),
  ('610000', 'fb_users', 'tabulka', 'Tabulka uživatelských účtů Facebooku – spravuje virtuální uživatele a jejich parametry (login, limity, stav, host, zamčení, pracovní časy atd.)', 'done', 1, NULL, NULL),
  ('620000', 'fb_groups', 'tabulka', 'Tabulka skupin na Facebooku – obsahuje metadata o skupinách, stavy, limity, statistiky a související informace.', 'done', 1, NULL, NULL),
  ...
  ('670000', 'urls', 'tabulka', 'Tabulka URL odkazů používaných pro příspěvky – obsahuje adresy, počet použití a metadata.', 'done', 1, NULL, NULL),
  ...
  ('6B0000', 'versions', 'tabulka', 'Historie a správa produkčních verzí systému.', 'done', 1, NULL, NULL),
