...
CREATE TABLE IF NOT EXISTS user_behavioral_profiles (
    ...
    avg_typing_speed DECIMAL(5,2) DEFAULT 150.0,
    typing_variance DECIMAL(3,2) DEFAULT 0.3,
    mistake_rate DECIMAL(4,3) DEFAULT 0.05,
    correction_style VARCHAR(20) DEFAULT 'casual',
    double_key_chance DECIMAL(4,3) DEFAULT 0.10,
    backspace_delay INT DEFAULT 200,
    impatience_level DECIMAL(3,2) DEFAULT 0.5,
    multitasking_tendency DECIMAL(3,2) DEFAULT 0.5,
    attention_span INT DEFAULT 90,
    decision_speed DECIMAL(3,2) DEFAULT 0.5,
    perfectionism DECIMAL(3,2) DEFAULT 0.5,
    base_mood VARCHAR(20) DEFAULT 'neutral',
    mood_volatility DECIMAL(3,2) DEFAULT 0.3,
    frustration_threshold DECIMAL(3,2) DEFAULT 0.7,
    energy_level DECIMAL(3,2) DEFAULT 0.8,
    scroll_intensity VARCHAR(10) DEFAULT 'medium',
    reading_speed DECIMAL(5,2) DEFAULT 240.0,
    distraction_chance DECIMAL(3,2) DEFAULT 0.2,
    procrastination_level DECIMAL(3,2) DEFAULT 0.4,
    like_frequency DECIMAL(4,3) DEFAULT 0.10,
    comment_tendency DECIMAL(4,3) DEFAULT 0.05,
    hover_behavior VARCHAR(20) DEFAULT 'normal',
    click_pattern VARCHAR(20) DEFAULT 'normal',
    learning_rate DECIMAL(3,2) DEFAULT 0.1,
    pattern_memory DECIMAL(3,2) DEFAULT 0.7,
    behavior_confidence DECIMAL(3,2) DEFAULT 0.5,
