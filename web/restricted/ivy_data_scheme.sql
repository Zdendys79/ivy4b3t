...
VALUES
    ...
    (
        ...
        'iv_fb.js',
        'soubor',
        'Modul pro interakci s Facebookem',
        'done',
        1,
        NULL,
        NULL
    ...
    (
        ...
        'cycleusers.js',
        'soubor',
        'Cyklické přepínání uživatelů na virtuálu pro vytvoření profilů browseru a přihlášení na Facebook',
        'done',
        1,
        NULL,
        NULL
    ...
    (
        ...
        'fb_users',
        'tabulka',
        'Tabulka uživatelských účtů Facebooku – spravuje virtuální uživatele a jejich parametry (login, limity, stav, host, zamčení, pracovní časy atd.)',
        'done',
        1,
        NULL,
        NULL
    ...
    (
        ...
        'fb_groups',
        'tabulka',
        'Tabulka skupin na Facebooku – obsahuje metadata o skupinách, stavy, limity, statistiky a související informace.',
        'done',
        1,
        NULL,
        NULL
    ...
    (
        ...
        'urls',
        'tabulka',
        'Tabulka URL odkazů používaných pro příspěvky – obsahuje adresy, počet použití a metadata.',
        'done',
        1,
        NULL,
        NULL
    ...
    (
        ...
        'versions',
        'tabulka',
        'Historie a správa produkčních verzí systému.',
        'done',
        1,
        NULL,
        NULL
