...
export class CeskySource extends BaseSource {
  ...
  getCzechProverbs() {
    const proverbs = [
      ...
      'Co si ustelešš, tak si lehneš.',
      'Jaký pán, takový krám.',
      'Kdo pozdě chodí, sám sobě škodí.',
      'Řemeslo má zlaté dno.',
      'Kdo se směje naposled, ten se směje nejlépe.',
      'Když se dva perou, třetí se směje.',
      'Když se dva hádají, třetí vítězí.',
      ...
      'Krásný den začíná ráno.',
      'Lidé přicházejí a odcházejí, ale přátelé zůstávají.',
      'Nejvíc se učíme z vlastních chyb.',
